...
const panel = readFileSync(new URL('../components/dataset/TrainingPanel.jsx', import.meta.url), 'utf8')
  ...
  + readFileSync(new URL("../../../bundled/cloud_training/frontend/shared/CloudTierEstimate.jsx", import.meta.url), 'utf8');
...
const stopDialog = readFileSync(new URL("../../../bundled/cloud_training/frontend/shared/cloudStopDialog.js", import.meta.url), 'utf8');
