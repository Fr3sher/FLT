...
export const PAGE_TOPICS = [
  ...
  action('bank-scrape', 'Scrape the web into a bank',
    ...
    '/bank', 'using-the-app', 'the-image-bank-triage-a-big-folder'),
  action('bank-qwen-refinement', 'Refine leading search results with Qwen',
    ['qwen', 'reranker', 'refine results', 'search refinement', 'top 20'],
    '/bank', 'using-the-app', 'refine-leading-search-results-with-qwen'),
