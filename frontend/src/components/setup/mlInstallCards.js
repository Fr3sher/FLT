...
export const ML_INSTALL_CARDS = [
  ...
  { action: 'bank_reranker', cap: 'bank_reranker', icon: '🔎',
    title: 'Qwen search refinement (optional)',
    body: 'Downloads Qwen3-VL-Reranker-2B (~4.3 GB) and installs its CPU runtime. Refines the first 20 Bank text-search results on demand, then releases memory. CPU use needs several GB of free RAM and can be slow; a configured CUDA runtime uses about 5 GB VRAM. Keeps the semantic index and image scores.' },
