...
export const SETTINGS_SECTIONS = [
  ...
  { id: 'engines', title: 'Image engines', icon: '🎨', eyebrow: 'generation',
    ...
    keywords: ['gemini', 'openai', 'openrouter', 'api key', 'chatgpt', 'nano banana', 'klein', 'engine', 'subscription', 'gpt-image',
...
export function sectionStatus(id, caps) {
  ...
  switch (id) {
    case 'engines':
      return (e.nanobanana || e.chatgpt || e.openrouter || e.klein) ? 'ready' : 'off'
    case 'local-tools': {
      const parts = [
