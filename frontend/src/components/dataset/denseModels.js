...
export function denseWhereChip(entry) {
  ...
  if (entry?.hub?.repo_id) {
    return { tone: 'info', label: 'On Hugging Face',
      title: 'The model is in this run’s private Hugging Face repository, not on this computer' };
  }
...
export function denseActions(entry) {
