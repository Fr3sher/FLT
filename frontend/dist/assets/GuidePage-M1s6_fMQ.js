<<<<<<<< HEAD:frontend/dist/assets/GuidePage-BVxpdu-X.js
<<<<<<<< HEAD:frontend/dist/assets/GuidePage-BVxpdu-X.js
import{j as e,r as v}from"./react-DEX5tgmF.js";import{n as A,J as C,o as R,ag as L,s as I}from"./index-BeZK6i7X.js";import{m as T,s as P,D as U}from"./DiagnosticReport-BFz_x3OD.js";function p(a,r="i"){const h=[],t=/(`[^`]+`)|(\*\*[^*]+\*\*)|(\*[^*]+\*)|(\[[^\]]+\]\([^)]+\))/g;let i=0,o,l=0;for(;(o=t.exec(a))!==null;){o.index>i&&h.push(a.slice(i,o.index));const n=o[0],d=`${r}-${l++}`;if(n.startsWith("`"))h.push(e.jsx("code",{className:"px-1 py-0.5 rounded bg-surface-raised text-indigo-200 text-[0.8125em] font-mono",children:n.slice(1,-1)},d));else if(n.startsWith("**"))h.push(e.jsx("strong",{className:"text-content font-semibold",children:n.slice(2,-2)},d));else if(n.startsWith("*"))h.push(e.jsx("em",{children:n.slice(1,-1)},d));else{const c=n.match(/^\[([^\]]+)\]\(([^)]+)\)$/);h.push(e.jsx("a",{href:c[2],target:"_blank",rel:"noreferrer",className:"text-indigo-300 underline decoration-indigo-400/40 hover:decoration-indigo-300",children:c[1]},d))}i=o.index+n.length}return i<a.length&&h.push(a.slice(i)),h}function j(a){const r=a.replace(/\r\n/g,`
========
import{j as e,r as v}from"./react-DEX5tgmF.js";import{h as A,s as C,i as L,a1 as R,k as I}from"./index-BDBu69Ug.js";import{m as T,s as P,D as U}from"./DiagnosticReport-D1Np5bMa.js";function p(a,r="i"){const h=[],t=/(`[^`]+`)|(\*\*[^*]+\*\*)|(\*[^*]+\*)|(\[[^\]]+\]\([^)]+\))/g;let i=0,o,l=0;for(;(o=t.exec(a))!==null;){o.index>i&&h.push(a.slice(i,o.index));const n=o[0],d=`${r}-${l++}`;if(n.startsWith("`"))h.push(e.jsx("code",{className:"px-1 py-0.5 rounded bg-surface-raised text-indigo-200 text-[0.8125em] font-mono",children:n.slice(1,-1)},d));else if(n.startsWith("**"))h.push(e.jsx("strong",{className:"text-content font-semibold",children:n.slice(2,-2)},d));else if(n.startsWith("*"))h.push(e.jsx("em",{children:n.slice(1,-1)},d));else{const c=n.match(/^\[([^\]]+)\]\(([^)]+)\)$/);h.push(e.jsx("a",{href:c[2],target:"_blank",rel:"noreferrer",className:"text-indigo-300 underline decoration-indigo-400/40 hover:decoration-indigo-300",children:c[1]},d))}i=o.index+n.length}return i<a.length&&h.push(a.slice(i)),h}function j(a){const r=a.replace(/\r\n/g,`
>>>>>>>> d8c18cc:frontend/dist/assets/GuidePage-DsbIcoVQ.js
========
import{j as e,z as A,m as C,s as L,r as v,ao as R,g as I}from"./index-RbqPfoXH.js";import{m as T,s as P,D as U}from"./DiagnosticReport-DmVx93OY.js";function p(a,r="i"){const h=[],t=/(`[^`]+`)|(\*\*[^*]+\*\*)|(\*[^*]+\*)|(\[[^\]]+\]\([^)]+\))/g;let i=0,o,l=0;for(;(o=t.exec(a))!==null;){o.index>i&&h.push(a.slice(i,o.index));const n=o[0],d=`${r}-${l++}`;if(n.startsWith("`"))h.push(e.jsx("code",{className:"px-1 py-0.5 rounded bg-surface-raised text-indigo-200 text-[0.8125em] font-mono",children:n.slice(1,-1)},d));else if(n.startsWith("**"))h.push(e.jsx("strong",{className:"text-content font-semibold",children:n.slice(2,-2)},d));else if(n.startsWith("*"))h.push(e.jsx("em",{children:n.slice(1,-1)},d));else{const c=n.match(/^\[([^\]]+)\]\(([^)]+)\)$/);h.push(e.jsx("a",{href:c[2],target:"_blank",rel:"noreferrer",className:"text-indigo-300 underline decoration-indigo-400/40 hover:decoration-indigo-300",children:c[1]},d))}i=o.index+n.length}return i<a.length&&h.push(a.slice(i)),h}function j(a){const r=a.replace(/\r\n/g,`
>>>>>>>> origin/main:frontend/dist/assets/GuidePage-M1s6_fMQ.js
`).split(`
...
`,D=`# Building a good LoRA dataset
...
`,z=`# Getting help & reporting problems
