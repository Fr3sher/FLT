...
| **Import or scrape** | Drag in images, merge ZIP/folder datasets, search Reddit, Pexels or the open web by keyword, or scan a gallery/direct-media URL — sites without a dedicated source are enumerated through gallery-dl (~300 sites); a site it does not recognize still returns a single item |
