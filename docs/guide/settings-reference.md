...
| `bank_semantic.device` | `'auto'` | Device for the SigLIP 2 image index (`auto`, `cuda`, `cpu`). A GPU run uses the same exclusive window as other Bank ML work. |
