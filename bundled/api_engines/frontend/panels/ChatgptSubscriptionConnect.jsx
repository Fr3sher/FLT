...
import { StatusBadge } from '@lds/plugin-sdk/ui'
import { connectFeedback } from '../lib/chatgptConnectFeedback.js'

/* The ChatGPT subscription (Codex OAuth) device-code login, as ONE component.
   It is the api_engines plugin's, and two of its surfaces mount it: the
   Settings group (ApiEnginesSettingsGroup) and the Setup lane (ChatgptSetupLane). Setup used to offer only the pay-per-use API
