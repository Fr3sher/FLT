...
import { isFixedLoraDuplicate, fixedLoraDuplicateWarning } from '@lds/plugin-sdk/lora';
import {
...
} from '../lib/kleinImproveEditor.js';
  ...
  return (
    ...
    <div className={`min-w-0 space-y-1 text-[0.6875rem] leading-relaxed ${className}`}>
      ...
      <p className="flex flex-wrap items-center gap-x-3 gap-y-1">
        ...
        <SettingsLink pluginId="image_upscale" focus="identity-prompt-klein-improve" className="min-h-10 lg:min-h-0 inline-flex items-center">
          All Klein prompts in Settings
        </SettingsLink>
        <SettingsLink pluginId="image_upscale" focus="klein-improve-strength" className="min-h-10 lg:min-h-0 inline-flex items-center">
