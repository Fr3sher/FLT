...
const SCRAPE_SECRETS = [
  {
    ...
    help: 'The same stored key used by the Civitai prompt browser and optional publisher. Replacing or removing it here applies everywhere.',
...
export default function ScrapeSettingsGroup(props) {
