...
import { nudgeImageNode } from '../../utils/canvasImageNodes.js';
import { CONTROL_UNITS, chromeScale, clusterUnits, groupCornerUnits, hasOwnResizeCorner, hasResizeCornerOver } from '../../utils/canvasNodeChrome.js';
import { imageFactsLine } from '@lds/plugin-sdk/canvas';
import { useImageDownload } from '@lds/plugin-sdk/canvas';
import { useCanvasImageDelete } from '../../hooks/useCanvasImageDelete.js';
import { canvasDeleteButtonState } from '../../utils/canvasImageDelete.js';
import { datasetThumbUrl, ratchetThumbSide } from '@lds/plugin-sdk/canvas';
...
/* 🖼 One generated image, pinned ON the board.
   ...
   ⚠️ Touch. Dragging a node and panning the board are the same physical
   ...
   ⚠️ …and the size of those controls is NOT a board size. Reported from a phone:
