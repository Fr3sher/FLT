...
import { readSource } from '../../../frontend/tests/support/readSource.mjs'
import test from 'node:test'

import { CANVAS_HELP } from '../frontend/help.js'
const getHelpTopic = id => CANVAS_HELP.find(topic => topic.id === id)
import { WHATS_NEW } from '../frontend/whatsNew.js'
import { WHATS_NEW_ARCHIVE } from '../../../frontend/src/whatsNewArchive.js'
