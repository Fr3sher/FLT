...
from lds_sdk.cloud_host.services.hf_publish import HfPublishError, _http_status, _make_api, _require_write_scope
...
def local_base_payload(family, base_model) -> dict:
    ...
    if family == 'zimage':
        ...
        from lds_sdk.cloud_host.services import zimage_convert
