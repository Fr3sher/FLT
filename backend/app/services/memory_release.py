...
* **ComfyUI** keeps the models it last used cached — offloaded to system RAM
  ...
  pass. Local training asks it only when `LDS_TRAINING_FREE_COMFYUI=1`, since
  the configured ComfyUI may serve another workload or use another GPU
  (`utils.comfyui.free_comfyui_vram`).
