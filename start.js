/* Pinokio start script — runs the Flask server as a Pinokio daemon.
   ...
   The URL is READ BACK from the terminal instead of being hardcoded: port 5051
   ...
   Environment:
   - LDS_PORT=5051    the app's default bind.
  ...
  run: [
    {
      ...
      params: {
        ...
        on: [{
          // backend/run.py prints "[LDS] Ready on http://127.0.0.1:5051/" once
